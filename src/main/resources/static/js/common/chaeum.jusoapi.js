...
document.getElementById("btnCloseLayer").addEventListener("click", closeDaumPostcode);
...
function searchPostcode(zipcodeId, addressId, addressDetailId) {
    new daum.Postcode({
        oncomplete: function(data) {
            ...
            // 커서를 상세주소 필드로 이동한다.
            document.getElementById(addressDetailId).focus();
